...
// --------- CHART COMPONENTS (NOW ACCEPT REAL DATA) ----------
  ...
  <Card className="border-none bg-muted/30">
    <CardHeader className="pb-2">
      ...
      <CardDescription className="text-xs">
        Where workload is concentrated.
      </CardDescription>
    </CardHeader>
...
const RevenueStageChart = ({
  ...
  <Card className="border-none bg-muted/30">
    <CardHeader className="pb-2">
      ...
      <CardDescription className="text-xs">
        Placeholder until you store lead value.
      </CardDescription>
    </CardHeader>
    <CardContent className="h-[200px] pt-4">
      <ResponsiveContainer width="100%" height="100%">
...
export function Pipeline() {
  ...
  // MVP: you have no revenue field yet → show 0s so it’s real, not fake
  const revenueData = [
    { stage: "New", revenue: 0 },
    { stage: "Qualifying", revenue: 0 },
    { stage: "Quoted", revenue: 0 },
    { stage: "Booked", revenue: 0 },
  ];
